...
function preencherLogin() {
    ...
    validateLoginButton('',username,'');
}

function preencherSenha() {
  password = document.getElementById("senha") as HTMLInputElement;
  password = password.value;
  validateLoginButton(password,username,'');
}

function preencherApi() {
  apiKey = document.getElementById("api-key") as HTMLInputElement;
  apiKey = apiKey.value;
  validateLoginButton(password,username,preencherApi);
}

function validateLoginButton(password:string, username: string, apiKey:string) {
